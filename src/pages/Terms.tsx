    ...
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <main className="flex-grow container mx-auto px-4 py-12">
        <div className="max-w-3xl mx-auto bg-blue-600/10 p-6 rounded-lg">
          <h1 className="text-3xl font-bold mb-6 text-center text-black">Terms and Conditions</h1>
          
          <div className="space-y-6 text-black/90">
            <section>
              <h2 className="text-xl font-bold mb-3 text-black">1. Submission Guidelines</h2>
            ...
            <section>
              <h2 className="text-xl font-bold mb-3 text-black">2. Content License</h2>
            ...
            <section>
              <h2 className="text-xl font-bold mb-3 text-black">3. Content Restrictions</h2>
            ...
            <section>
              <h2 className="text-xl font-bold mb-3 text-black">4. Age Requirements</h2>
            ...
            <section>
              <h2 className="text-xl font-bold mb-3 text-black">5. Attribution</h2>
